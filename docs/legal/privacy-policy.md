...
- Date of birth
- Social Security number (insurance only)
...
### Without Authorization (Permitted by Law)
...
|-----------|-----------------|
| Medical records | 10 years (Illinois law) |
| Billing records | 7 years |
| Consent forms | 10 years |
| General inquiries | 3 years |
...
- **Analytics cookies:** Understand usage (Google Analytics)
...
### Do Not Track
- We honor browser DNT signals

### Data Deletion
- Request deletion of non-required data
...
- Know if data is sold
- Opt out of data sales
- Equal service regardless of choices
...
Your signature on our intake forms acknowledges receipt of this Privacy Policy and HIPAA Notice.

---

*This document is available at hellogorgeousmedspa.com/privacy*
