...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE.url}/explore-care`, lastModified: now },
    ...
    { url: `${SITE.url}/services/aesthetics-injectables`, lastModified: now },
    { url: `${SITE.url}/services/weight-loss-metabolic-care`, lastModified: now },
    { url: `${SITE.url}/services/hormones-wellness`, lastModified: now },
    { url: `${SITE.url}/services/skin-regeneration`, lastModified: now },
    { url: `${SITE.url}/services/iv-therapy-recovery`, lastModified: now },
    { url: `${SITE.url}/services/hair-restoration`, lastModified: now },
    { url: `${SITE.url}/services/pain-recovery`, lastModified: now },
    { url: `${SITE.url}/services/lashes-brows-beauty`, lastModified: now },
    { url: `${SITE.url}/services/medical-visits-consultations`, lastModified: now },
