...
export function QuizCTA() {
  return (
    <section className="py-16 px-4 bg-gradient-to-r from-pink-950/30 via-purple-950/30 to-pink-950/30">
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-pink-500/20 to-purple-500/20 border border-pink-500/30 p-8 md:p-12">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="flex-shrink-0">
                <Link
                  href="/quiz"
                  className="inline-flex items-center gap-3 px-8 py-4 rounded-2xl bg-gradient-to-r from-pink-500 to-purple-500 text-white font-bold text-lg hover:opacity-90 transition transform hover:scale-105 shadow-lg shadow-pink-500/25"
                >
